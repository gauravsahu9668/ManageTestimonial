...
const FinalVideo:React.FC<VideoReviewProps>=({setVideoPopup,setthankpopup,setloading})  => {
  ...
  return (
    ...
    //     <div className="w-[34%]  flex flex-col items-center relative h-[90vh] p-3 overflow-y-scroll  inset-0  rounded-md bg-[white]  ">  
    //         <div onClick={()=>{setVideoPopup(false)}}  className="fixed right-2 top-2 flex items-center justify-center rounded-md bg-[#a1a1a1] cursor-pointer hover:bg-[#d89393] w-[30px] h-[30px]">
    //             <RxCross2></RxCross2>
    //         </div>
    //         {
    //             noscreen ? 
    ...
    //                      {reviewVideo && <video  src={reviewVideo} autoPlay className=" w-[300px] h-[200px]  rounded-lg "></video>}
    //                     </div>
                        
    //                     <input onChange={handleUplaodChange} id="image-file"  type="file"></input>
    //               </div>
    //              </div>
    //              </>               
    //             :
    //             <div className="flex flex-col w-full items-center">
    //                 <div className="w-[40px] mt-3 h-[40px] rounded-full flex items-center justify-center">
    //                   <CiVideoOn></CiVideoOn>
    //                 </div>
    ...
    //                        autoPlay
    //                        muted
    //                        className="w-[400px] h-[300px] mx-auto  border rounded-lg mt-3 shadow-md mb-4"
    //                 ></video>
    ...
    //                           :
    //                           <>
    //                           <button onClick={downloadVideo}  className="px-6 py-3 w-full bg-[#5db94a] text-white font-semibold rounded-lg shadow-md  transition duration-300">
    //                            Download video
    //                           </button>
    //                           </>
    //                         :
    ...
    //            <input  value={custName} onChange={(e)=>{setcustName(e.target.value)}} required type="text" id="nameSender" className="outline-none  focus:border-[#2563EB] focus:border-[2px] p-2 rounded-md mt-3 border-[1px] border-[#a2a3a4]"></input>
    //          </div>
    //          <div className="flex mt-6 flex-col text-[#3a3b3c] w-full justify-center">
    //            <label htmlFor="senderEmail" className="text-[#3a3b3c]">Your Email *</label>
    //            <input value={custEmail} onChange={(e)=>{setcustEmail(e.target.value)}} required type="email" id="senderEmail" className="outline-none  focus:border-[#2563EB] focus:border-[2px] p-2 rounded-md mt-3 border-[1px] border-[#a2a3a4]"></input>
    //          </div>
    ...
    //          </div>
    //         </form>
    //          <div onClick={sendHandler} className="w-full text-[18px]  font-semibold flex items-center justify-center py-2 bg-[#5D5DFF] rounded-lg mt-10">
    //            Send
    //          </div>
    ...
    // </div>
    <div className="w-full h-screen absolute left-0 top-0 flex items-center justify-center bg-black/30 backdrop-blur-sm">
    <div className="w-[34%] flex flex-col items-center relative h-[90vh] p-3 overflow-y-scroll scrollbar overflow-x-hidden inset-0 rounded-md bg-[#F9FAFB] shadow-lg">  
